            ...
            <div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="mb-7">
                        ...
                        {errors.name?.type === "maxLength" && (<p>Name must be at most 30 characters</p>)}
                    </div>
                    <div className="my-7">
                        ...
                        {errors.email?.type === "minLength" && (<p>Email must be at least 2 characters</p>)}
                        {errors.email?.type === "maxLength" && (<p>Email must be at most 30 characters</p>)}
                    </div>
                    <div className="my-7">
                        <Label className="mb-2" htmlFor="phone">Phone Number</Label>
                        <Input {...register("phone", { minLength: 6, maxLength: 15, pattern: /^\+?[1-9][0-9]{7,14}$/ })}
                            type="text" id="phone" name="phone" placeholder="Phone No." />
                        {errors.phone?.type === "pattern" && (<p>Invalid Phone Number</p>)}
                        {errors.phone?.type === "minLength" && (<p>Phone Number must be at least 6 characters</p>)}
                        {errors.phone?.type === "maxLength" && (<p>Phone Number must be at most 15 characters</p>)}
                    </div>
                    <div className="my-7">
                        ...
                        {errors.message?.type === "minLength" && (<p>Message must be at least 30 characters</p>)}
                        {errors.message?.type === "maxLength" && (<p>Message must be at most 500 characters</p>)}
                    </div>
